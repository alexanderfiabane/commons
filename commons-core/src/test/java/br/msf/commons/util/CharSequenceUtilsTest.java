...
import br.ojimarcius.commons.text.MatchEntry;
import static br.ojimarcius.commons.util.CharSequenceUtils.compare;
import static br.ojimarcius.commons.util.CharSequenceUtils.containsPattern;
import static br.ojimarcius.commons.util.CharSequenceUtils.countOccurrencesOf;
import static br.ojimarcius.commons.util.CharSequenceUtils.find;
import static br.ojimarcius.commons.util.CharSequenceUtils.findPattern;
import static br.ojimarcius.commons.util.CharSequenceUtils.hasAccents;
import static br.ojimarcius.commons.util.CharSequenceUtils.indexOf;
import static br.ojimarcius.commons.util.CharSequenceUtils.isBlankOrNull;
import static br.ojimarcius.commons.util.CharSequenceUtils.isEmptyOrNull;
import static br.ojimarcius.commons.util.CharSequenceUtils.isNotBlank;
import static br.ojimarcius.commons.util.CharSequenceUtils.isNotEmpty;
import static br.ojimarcius.commons.util.CharSequenceUtils.lastIndexOf;
import static br.ojimarcius.commons.util.CharSequenceUtils.length;
import static br.ojimarcius.commons.util.CharSequenceUtils.listParams;
import static br.ojimarcius.commons.util.CharSequenceUtils.removeAccents;
import static br.ojimarcius.commons.util.CharSequenceUtils.toNullSafeString;
