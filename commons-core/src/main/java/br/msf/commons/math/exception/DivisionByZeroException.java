...
/**
 * Exception thrown when the attempt of a division by zero is detected.
 *
...
public class DivisionByZeroException extends RuntimeException {
    ...
    private static final long serialVersionUID = 4947035353284639732L;
    /**
     * Default message used when none is defined.
     */
    private static final String DEFAULT_MESSAGE = "Division by zero.";
