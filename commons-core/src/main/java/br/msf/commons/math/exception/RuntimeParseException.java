...
public class RuntimeParseException extends RuntimeException {
    ...
    private static final long serialVersionUID = -6272020578197967506L;
    /**
     * Default message used when none is defined.
     */
    private static final String DEFAULT_MESSAGE = "Could not parse data.";
     ...
     */
    public RuntimeParseException(final String message) {
        this(message, null);
    }
     ...
     */
    public RuntimeParseException(final Throwable cause) {
     ...
     * @param cause   The cause for the new exception.
     */
    public RuntimeParseException(final String message, final Throwable cause) {
        super(message, cause);
    }
}
