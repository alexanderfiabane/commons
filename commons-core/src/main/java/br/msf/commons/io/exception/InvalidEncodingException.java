...
/**
 * Exception thrown when an invalid encoding is given.
 *
...
public class InvalidEncodingException extends RuntimeException {
     ...
     */
    private static final String DEFAULT_MESSAGE = "The given encoding is invalid.";
     ...
     */
    public InvalidEncodingException(final String message) {
        this(message, null);
    }
     ...
     */
    public InvalidEncodingException(final Throwable cause) {
     ...
     * @param cause   The cause for the new exception.
     */
    public InvalidEncodingException(final String message, final Throwable cause) {
        super(message, cause);
    }
}
