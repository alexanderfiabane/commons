...
public class ImageIOException extends RuntimeException {
     ...
     */
    private static final String DEFAULT_MESSAGE = "Could not read/write image.";
     ...
     */
    public ImageIOException(final String message) {
        this(message, null);
    }
     ...
     */
    public ImageIOException(final Throwable cause) {
     ...
     * @param cause   The cause for the new exception.
     */
    public ImageIOException(final String message, final Throwable cause) {
        super(message, cause);
    }
}
