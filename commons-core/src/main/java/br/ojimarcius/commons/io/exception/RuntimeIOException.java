...
public class RuntimeIOException extends RuntimeException {
    ...
    private static final long serialVersionUID = 4444544157963716913L;
    /**
     * Default message used when none is defined.
     */
    private static final String DEFAULT_MESSAGE = "Error processing input/output.";
