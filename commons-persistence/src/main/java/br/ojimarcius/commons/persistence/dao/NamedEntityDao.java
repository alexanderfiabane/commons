...
import br.ojimarcius.commons.persistence.model.NamedEntity;
 ...
 */
public interface NamedEntityDao<ID extends Serializable & Comparable<ID>, T extends NamedEntity<ID>> extends EntityDao<ID, T> {
